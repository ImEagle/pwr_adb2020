...
VENDORS_AMOUNT = 10000

ORDERS_ITEMS_AMOUNT = (1, 5)

# === ORDERS ===
# Orders created per Customer
ORDERS_AMOUNT = (100, 1000)
...
# === PROMOTIONS ITEMS ===
# Promotions items per Promotion
PROMOTIONS_ITEMS_AMOUNT = (1, 20)
